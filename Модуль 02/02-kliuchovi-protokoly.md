...
### Перехоплення облікових даних (небезпечні порти)

| Порт   | Сервіс              | Опис                              | Основні ризики |
|--------|---------------------|-----------------------------------|----------------|
| 22     | SSH                 | Захищений віддалений доступ       | Брутфорс паролів (якщо не використовуються ключі) |
...
| 3389   | RDP                 | Віддалений робочий стіл Windows   | Брутфорс, BlueKeep та інші CVE |
